...
$goldDisc = db_fetch(db_query("SELECT GoldDisc FROM game WHERE RoomID=$roomID"))[0];
$goldGen = db_fetch(db_query("SELECT GoldGen FROM game WHERE RoomID=$roomID"))[0];
$feuerfallenDisc = db_fetch(db_query("SELECT FeuerfallenDisc FROM game WHERE RoomID=$roomID"))[0];
$feuerfallenGen = db_fetch(db_query("SELECT FeuerfallenGen FROM game WHERE RoomID=$roomID"))[0];
